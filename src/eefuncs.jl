...
Base.:&(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = bitwiseAnd(x,y)
Base.:&(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = bitwiseAnd(typeof(y)(x),y)
Base.:|(x::T,y::T) where {T <: AbstractEEObject} = bitwiseOr(x,y)
Base.:|(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = bitwiseOr(x,y)
Base.:|(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = bitwiseOr(typeof(y)(x),y)
Base.:⊻(x::T,y::T) where {T <: AbstractEEObject} = bitwiseXor(x,y)
Base.:⊻(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = bitwiseXor(x,y)
Base.:⊻(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = bitwiseXor(typeof(y)(x),y)
Base.:>>(x::T,y::T) where {T <: AbstractEEObject} = rightShift(x,y)
Base.:>>(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = rightShift(x,y)
Base.:>>(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = rightShift(typeof(y)(x),y)
Base.:<<(x::T,y::T) where {T <: AbstractEEObject} = leftShift(x,y)
Base.:<<(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = leftShift(x,y)
Base.:<<(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = leftShift(typeof(y)(x),y)

# numeric comparisons
isequal(x::T,y::T) where {T <: AbstractEEObject} = eq(x,y)
isequal(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = eq(x,y)
isequal(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = eq(typeof(y)(x),y)
isless(x::T,y::T) where {T <: AbstractEEObject} = lt(x,y)
isless(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = lt(x,y)
isless(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = lt(typeof(y)(x),y)
==(x::T,y::T) where {T <: AbstractEEObject} = eq(x,y)
==(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = eq(x,y)
==(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = eq(typeof(y)(x),y)
!=(x::T,y::T) where {T <: AbstractEEObject} = neq(x,y)
!=(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = neq(x,y)
!=(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = neq(typeof(y)(x),y)
≠(x::T,y::T) where {T <: AbstractEEObject} = neq(x,y)
≠(x::T,y::S) where {T <: AbstractEEObject, S <: Real} = neq(x,y)
≠(x::S,y::T) where {T <: AbstractEEObject, S <: Real} = neq(typeof(y)(x),y)
